...
export const randomFactList = [
  ...
  "There is a part of Yellowstone National Park where a person could theoretically get away with murder due to a legal loophole.",
