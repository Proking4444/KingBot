...
exports.MojaveDesertImage1 = MojaveDesertImage1;
...
const MojaveDesertImage2 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage2 = MojaveDesertImage2;
...
const MojaveDesertImage3 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage3 = MojaveDesertImage3;
...
const MojaveDesertImage4 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage4 = MojaveDesertImage4;
...
const MojaveDesertImage5 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage5 = MojaveDesertImage5;
...
const MojaveDesertImage6 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage6 = MojaveDesertImage6;
...
const MojaveDesertImage7 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage7 = MojaveDesertImage7;
...
const MojaveDesertImage8 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage8 = MojaveDesertImage8;
...
const MojaveDesertImage9 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage9 = MojaveDesertImage9;
...
const MojaveDesertImage10 = new EmbedBuilder()
    ...
    .setFooter({ text: 'Photo taken by Ari Khan' });
exports.MojaveDesertImage10 = MojaveDesertImage10;//Class Memes
...
exports.ClassMeme21 = ClassMeme21;

const ClassMeme22 = new EmbedBuilder()
    .setTitle('Nikan Lore')
    .setImage('https://i.imgflip.com/8hp8p0.jpg')
    .setFooter({ text: 'Created by Anonymous' });
exports.ClassMeme22 = ClassMeme22;

const ClassMeme23 = new EmbedBuilder()
    .setTitle('Ian C. Lore 2')
    .setImage('https://i.imgflip.com/8hpdiv.jpg')
    .setFooter({ text: 'Created by Ari Khan' });
...
const ClassMeme25 = new EmbedBuilder()
    .setTitle('Ian C. Lore 3')
    .setImage('https://i.imgflip.com/8hpes9.jpg')
    .setFooter({ text: 'Created by Ari Khan' });
exports.ClassMeme25 = ClassMeme25;

const ClassMeme26 = new EmbedBuilder()
    .setTitle('Skiing Lore')
    .setImage('https://i.imgflip.com/8hs25z.jpg')
    .setFooter({ text: 'Created by Ari Khan' });
exports.ClassMeme26 = ClassMeme26;

const ClassMeme27 = new EmbedBuilder()
    .setTitle('Chloe Lore')
    .setImage('https://i.imgflip.com/8i0rwu.gif')
    .setFooter({ text: 'Created by Anonymous' });
exports.ClassMeme27 = ClassMeme27;

const ClassMeme28 = new EmbedBuilder()
    .setTitle('Geography Lore')
    .setImage('https://i.postimg.cc/LsCxDkkZ/2024-03-05-0uc-Kleki.png')
    .setFooter({ text: 'Created by Amy Wang' });
exports.ClassMeme28 = ClassMeme28;

const ClassMeme29 = new EmbedBuilder()
    .setTitle('Ms. Deluca Lore')
    .setImage('https://i.imgflip.com/8iarvn.jpg')
    .setFooter({ text: 'Created by Anonymous' });
exports.ClassMeme29 = ClassMeme29;

const ClassMeme30 = new EmbedBuilder()
    .setTitle('Tyler Lore')
    .setImage('https://i.imgflip.com/8ix4ht.jpg')
    .setFooter({ text: 'Created by Anonymous' });
exports.ClassMeme30 = ClassMeme30;

const ClassMeme31 = new EmbedBuilder()
    .setTitle('Ian X. Lore 2')
    .setImage('https://i.postimg.cc/rs1L5fxR/image.png')
    .setFooter({ text: 'Created by Anonymous' });
exports.ClassMeme31 = ClassMeme31;
...
exports.ClassMeme32 = ClassMeme32;
...
exports.randomJokeList = randomJokeList;
...
exports.randomLongJokeList = randomLongJokeList;
...
exports.randomFactList = randomFactList;
...
exports.randomAriQuoteList = randomAriQuoteList;
